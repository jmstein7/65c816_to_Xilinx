...
Run your program by using the address + "R" at the monitor prompt. For example, if you load your program into $1000, you would type 1000R and then <enter>. Make sure to jump or rts to $C385 at the end of your program. This is the exit point that will return you to your monitor.
